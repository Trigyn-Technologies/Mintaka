...
entity_geo_contains = "(ST_Contains(ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s))), entity_table.geo_property))"
...
attrubutes_geo_contains = "(attributes_table.id = %(geo_attr_value)s AND ST_Contains(ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s))),attributes_table.geo_property))"
