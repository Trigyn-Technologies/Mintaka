...
entity_geo_dwithin = "(ST_DWithin(entity_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s))),%(geo_distance)s))"
entity_geo_not_dwithin = "(NOT(ST_DWithin(entity_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s))),%(geo_distance)s)))"
entity_geo_within = "(ST_Within(entity_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s)))))"
entity_geo_contains = "(ST_Contains(entity_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s)))))"
entity_geo_intersects = "(ST_Intersects(entity_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s)))))"
entity_geo_equals = "(ST_Equals(entity_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s)))))"
entity_geo_disjoint= "(ST_Disjoint(entity_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s)))))"
entity_geo_overlaps = "(ST_Overlaps(entity_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s)))))"
attrubutes_geo_dwithin = "(attributes_table.id = %(geo_attr_value)s AND ST_DWithin(attributes_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s))),%(geo_distance)s))"
attrubutes_geo_not_dwithin = "(NOT(attributes_table.id = %(geo_attr_value)s AND ST_DWithin(attributes_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s))),%(geo_distance)s)))"
attrubutes_geo_within = "(attributes_table.id = %(geo_attr_value)s AND ST_Within(attributes_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s)))))"
attrubutes_geo_contains = "(attributes_table.id = %(geo_attr_value)s AND ST_Contains(attributes_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s)))))"
attrubutes_geo_intersects = "(attributes_table.id = %(geo_attr_value)s AND ST_Intersects(attributes_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s)))))"
attrubutes_geo_equals = "(attributes_table.id = %(geo_attr_value)s AND ST_Equals(attributes_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s)))))"
attrubutes_geo_disjoint= "(attributes_table.id = %(geo_attr_value)s AND ST_Disjoint(attributes_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s)))))"
attrubutes_geo_overlaps = "(attributes_table.id = %(geo_attr_value)s AND ST_Overlaps(attributes_table.geo_property, ST_GeomFromText(ST_AsText(ST_GeomFromGeoJSON(%(geo_property)s)))))"
