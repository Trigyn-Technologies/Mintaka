...
attributes_statement = "(attributes_table.id = %(attr_value)s AND ((attributes_table.value_type = 'value_string' AND attributes_table.value_string %(operation)s %(opr_value)s) OR  (attributes_table.value_type = 'value_number' AND attributes_table.value_number %(operation)s %(opr_value)s) OR (attributes_table.value_type = 'value_relation' AND attributes_table.value_relation %(operation)s %(opr_value)s)))"
attributes_true_statement = "(attributes_table.id = %(attr_value)s AND (attributes_table.value_type = 'value_boolean' AND attributes_table.value_boolean %(operation)s true))"
attributes_false_statement = "(attributes_table.id = %(attr_value)s AND (attributes_table.value_type = 'value_boolean' AND attributes_table.value_boolean %(operation)s false))"
attributes_datetime_statement = "(attributes_table.id = %(attr_value)s AND (attributes_table.value_type = 'value_datetime' AND attributes_table.value_datetime %(operation)s %(opr_value)s))"
...
attributes_object_statement = "(attributes_table.id = %(attr_value)s AND (attributes_table.value_type = 'value_object' AND (attributes_table.value_object is like %(col_value)s AND attributes_table.value_object is like %(opr_value)s)))"
...
sub_attributes_statement = "(attributes_table.id = %(attr_value)s AND attribute_sub_properties_table.id = %(sub_value)s AND ((attribute_sub_properties_table.value_type = 'value_string' AND attribute_sub_properties_table.value_string %(operation)s %(opr_value)s) OR  (attribute_sub_properties_table.value_type = 'value_number' AND attribute_sub_properties_table.value_number %(operation)s %(opr_value)s) OR (attribute_sub_properties_table.value_type = 'value_relation' AND attribute_sub_properties_table.value_relation %(operation)s %(opr_value)s)))"
sub_attributes_true_statement = "(attributes_table.id = %(attr_value)s AND attribute_sub_properties_table.id = %(sub_value)s AND (attribute_sub_properties_table.value_type = 'value_boolean' AND attribute_sub_properties_table.value_boolean %(operation)s true))"
sub_attributes_false_statement = "(attributes_table.id = %(attr_value)s AND attribute_sub_properties_table.id = %(sub_value)s AND (attribute_sub_properties_table.value_type = 'value_boolean' AND attribute_sub_properties_table.value_boolean %(operation)s false))"
sub_attributes_datetime_statement = "(attributes_table.id = %(attr_value)s AND attribute_sub_properties_table.id = %(sub_value)s AND (attribute_sub_properties_table.value_type = 'value_datetime' AND attribute_sub_properties_table.value_datetime %(operation)s %(opr_value)s))"
sub_attributes_object_statement = "(attributes_table.id = %(attr_value)s AND attribute_sub_properties_table.id = %(sub_value)s AND (attribute_sub_properties_table.value_type = 'value_object' AND (attribute_sub_properties_table.value_object is like %(col_value)s AND attribute_sub_properties_table.value_object is like %(opr_value)s)))"
